...
public class PacketCodec {
...

    {
        ...
        packetTypeMap.put(ADD_BUDDY_REQUEST, AddBuddyRequestPacket.class);
        packetTypeMap.put(ADD_BUDDY_RESPONSE, AddBuddyResponsePacket.class);
        packetTypeMap.put(ADD_BUDDY_ASK_REQUEST, AddBuddyAskRequestPacket.class);
        packetTypeMap.put(ADD_BUDDY_ASK_RESPONSE, AddBuddyAskResponsePacket.class);
    }
